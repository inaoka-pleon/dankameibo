    ...
    <main class="mt-1 py-2 px-2 sm:px-4">
        ...
        <div class="mb-4 flex flex-col justify-center items-center">
            <div class="flex justify-between bg-white border-l-8 border-b-2 border-slate-500 shadow-sm py-3 sm:py-4 px-4 sm:px-4 rounded-bl w-full max-w-7xl">
                <div class="text-gray-800 text-xl font-semibold">ユーザー / 編集</div>
            </div>
        </div>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="registration-body">
                                <input type="text" name="name" class="registration-input" placeholder="例：山田　太郎" value="{{ $user->name }}"/>
                            </td>
                        </tr>
                        <tr>
                            <th class="registration-item">ユーザー名かな</th>
                            <td class="registration-body">
                                <input type="text" name="name_kana" class="registration-input" placeholder="例：やまだ　たろう" value="{{ $user->name_kana }}"/>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="registration-body">
                                <input type="text" name="email" class="registration-input" placeholder="例：sample@sample.com" value="{{ $user->email }}"/>
                            </td>
                        </tr>
                        <tr>
                            <th class="registration-item">備考</th>
                            <td class="registration-body">
                                <textarea type="text" name="memo" class="registration-textarea" value="{{ $user->memo }}"></textarea>
                            </td>
                        </tr>
                    </tbody>
                </table>
