<x-app-layout>
    <x-slot name="header">
        <h2 class="header header-inner">寺格 / 編集</h2>
    </x-slot>
    ...
    <div class="registration">
        <form action="{{ route('jikaku.update', $jikaku->id) }}" method="post">
            @csrf
            @method('PATCH')
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="registration-body">
                            <input type="text" name="jikaku" class="registration-input" value="{{ $jikaku->jikaku }}" />  
                        </td>
                    </tr>
                </tbody>
            </table>
