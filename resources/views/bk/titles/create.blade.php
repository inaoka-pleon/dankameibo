<x-app-layout>
    <x-slot name="header">
        <h2 class="header header-inner">敬称 / 新規登録</h2>
    </x-slot>
    ...
    <div class="registration">
        <form action="{{ route('title.store') }}" method="post">
            ...
            <table class="registration-table">
                <tbody>
                    <tr>
                        <th class="registration-item">敬称
                            <span class="registration-item-required">必須</span>
                        </th>
                        <td class="registration-body">
                            <input type="text" name="title" class="registration-input" placeholder="敬称を入力してください" />
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <div class="form-btn">
                <a class="form-btn2 form-inline-block" href="{{ route('title.index') }}">戻る</a>
