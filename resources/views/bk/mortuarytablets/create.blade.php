<x-app-layout>
    <x-slot name="header">
        <h2 class="header header-inner">位牌区分 / 新規登録</h2>
    </x-slot>
    ...
    <div class="registration">
        <form action="{{ route('mortuarytablet.store') }}" method="post">
            @csrf
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="registration-body">
                            <input type="text" name="mortuarytablet" class="registration-input" placeholder="位牌区分を入力してください" />
                        </td>
                    </tr>
                </tbody>
            </table>
