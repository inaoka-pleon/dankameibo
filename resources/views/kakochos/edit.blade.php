    ...
    <main class="mt-1 py-4 px-2 sm:px-4">
        ...
        <div class="mb-4 flex flex-col justify-center items-center">
            <div class="flex justify-between bg-white border-l-8 border-b-2 border-slate-500 shadow-sm py-3 sm:py-4 px-4 sm:px-4 rounded-bl w-full max-w-7xl">
                <div class="text-gray-800 text-xl font-semibold">過去帳 / 編集</div>
            </div>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="registration-body">
                                <input type="text" name="zokumyou" class="registration-input" value="{{ $kakocho->zokumyou ?? $kakocho->name }}" />
                        </tr>
                        <tr>
                            ...
                            <td class="registration-body">
                                <input type="text" name="zokumyoukana" class="registration-input" value="{{ $kakocho->zokumyoukana ?? $kakocho->namekana }}" />
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="registration-body">
                                ...
                                <input type="number" name="death_year" class="w-1/6" min="1" max="99" placeholder="年" value="{{ old('death_year', $kakocho->death_year) }}">
                                <label class="pt-2">年</label>
                                <input type="number" name="death_month" class="w-1/6" min="1" max="12" placeholder="月" value="{{ old('death_month', $kakocho->death_month) }}">
                                <label class="pt-2">月</label>
                                <input type="number" name="death_day" class="w-1/6" min="1" max="31" placeholder="日" value="{{ old('death_day', $kakocho->death_day) }}">
