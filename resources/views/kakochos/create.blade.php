    ...
    <main class="mt-2 py-2 px-2 sm:px-4">
        ...
        <div class="mb-3 flex flex-col justify-center items-center">
            <div class="header-container">
                <div class="header-title">過去帳 / 新規登録</div>
            </div>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="registration-body">
                                <input type="text" name="zokumyou" class="registration-input" placeholder="例：山田　太郎" value="{{ old('zokumyou') }}" />
                        </tr>
                        <tr>
                            ...
                            <td class="registration-body">
                                <input type="text" name="zokumyoukana" class="registration-input" placeholder="例：やまだ　たろう" value="{{ old('zokumyoukana') }}" />
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="registration-body">
                                ...
                                <input type="number" name="death_year" class="registration-input-mini" min="1" max="99" placeholder="年" value="{{ old('death_year') }}">
                                <label class="pt-2">年</label>
                                <input type="number" name="death_month" class="registration-input-mini" min="1" max="12" placeholder="月" value="{{ old('death_month') }}">
                                <label class="pt-2">月</label>
                                <input type="number" name="death_day" class="registration-input-mini" min="1" max="31" placeholder="日" value="{{ old('death_day') }}">
