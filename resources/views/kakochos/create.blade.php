                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="registration-body">
                                <input type="text" name="zokumyou" class="registration-input" placeholder="例：姓　名" value="{{ old('zokumyou') }}" />
                        </tr>
                        <tr>
                            ...
                            <td class="registration-body">
                                <input type="text" name="zokumyoukana" class="registration-input" placeholder="例：せい　めい" value="{{ old('zokumyoukana') }}" />
                        </tr>
                        <tr>
