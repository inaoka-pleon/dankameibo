    ...
    <main class="mt-1 py-4 px-2 sm:px-4">
        ...
        <div class="mb-4 flex flex-col justify-center items-center">
            <div class="flex justify-between bg-white border-l-8 border-b-2 border-slate-500 shadow-sm py-3 sm:py-4 px-4 sm:px-4 rounded-bl w-full max-w-7xl">
                <div class="text-gray-800 text-xl font-semibold">家族情報 / 編集</div>
            </div>
        </div>
        ...
        <div class="registration">
            <form action="{{ route('follower.update', $follower->id) }}" method="post">
                @csrf
                @method('PATCH')
                ...
                <table class="registration-table">
                    <tbody>
                            ...
                            <td class="registration-body">
                                <select id ="relationship" name="relationship" class="registration-select">
                                    ...
                                    @foreach($relationships as $relationship)
                                        ...
                                        @else
                                            <!-- 初期表示時 -->
                                            @if($relationship->value1 === $follower->relationship)
                        ...
                        <tr>
                            ...
                            <td class="registration-body">
                                <input type="text" name="address1" class="registration-input" value="{{ $follower->address1 }}" />
                            </td>
                        </tr>
                        <tr>
                            <th class="registration-item">住所２</th>
                            <td class="registration-body">
                                <input type="text" name="address2" class="registration-input" value="{{ $follower->address2 }}" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="registration-body">
                                <input type="text" name="tel" class="registration-input" value="{{ $follower->tel }}" />
                            </td>
                        </tr>
                        <tr>
                            <th class="registration-item">FAX</th>
                            <td class="registration-body">
                                <input type="text" name="fax" class="registration-input" value="{{ $follower->fax }}" />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="registration-body">
                                <textarea type="text" name="memo" class="registration-textarea" value="{{ $follower->memo }}">{{ $follower->memo }}</textarea>
                            </td>
                        </tr>
                    </tbody>
                </table>
                <div class="form-btn">
                    <a class="form-btn2 form-inline-block" href="{{ route('danka.show', $follower->danka_id) }}">
