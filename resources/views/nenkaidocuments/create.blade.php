<x-app-layout>
    ...
    <main class="mt-1 py-4 px-2 sm:px-4">
        ...
        <div class="registration">
            <form action="{{ route('nenkaidocument.store') }}" method="POST">
                @csrf
                ...
                <table class="registration-table">
                    ...
                    <tr>
                        ...
                        <td class="registration-body">
                            <input type="text" name="document7" class="registration-input" placeholder="３６文字以内で入力してください" value="{{ old('document7') }}" />
                        </td>
                    </tr>
                    <tr>
                        <th class="registration-item">文８</th>
                        <td class="registration-body">
                            <input type="text" name="document8" class="registration-input" placeholder="３６文字以内で入力してください" value="{{ old('document8') }}" />
                        </td>
                    </tr>
                    <tr>
                        <th class="registration-item">文９</th>
                        <td class="registration-body">
                            <input type="text" name="document9" class="registration-input" placeholder="３６文字以内で入力してください" value="{{ old('document9') }}" />
                        </td>
                    </tr>
                </table>
                <div class="form-btn">
