<x-app-layout>
    ...
    <main class="py-2 px-2 sm:px-4">
        ...
        <div class="flex flex-col justify-center items-center mb-8">
            ...
            <hr class="w-full mb-3">
            <form action="{{ route('tanagyouheader.update', $tanagyou_header_id) }}" class="mb-3 w-full" method="POST">
                @csrf
                @method('PATCH')
                                ...
                                <tbody>
                                    ...
                                    @foreach ($tanagyou_details as $tanagyou_detail)
                                        <tr>
                                            ...
                                            <td data-th="氏名">{{ $tanagyou_detail->name }}</td>
                                            <td data-th="住所">{{ $tanagyou_detail->address1 . $tanagyou_detail->address2 }}</td>
                                            <td data-th="電話番号">{{ $tanagyou_detail->tel }}</td>
                                            <td data-th="月"><input type="text" name="month_{{$i}}" id="month_{{$i}}" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus-ring-opacity-50 w-full" value="{{ old('month_' . $i, $tanagyou_detail->month ?? 8) }}"></td>
                                            <td data-th="日"><input type="text" name="day_{{$i}}" id="day_{{$i}}" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus-ring-opacity-50 w-full" value="{{ $tanagyou_detail->day }}"></td>
                                            <td data-th="午前午後">
                                            ...
                                            <td data-th="時"><input type="text" name="hour_{{$i}}" id="hour_{{$i}}" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus-ring-opacity-50 w-full" value="{{ $tanagyou_detail->hour }}"></td>
                                            <td data-th="分"><input type="text" name="minute_{{$i}}" id="minute_{{$i}}" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus-ring-opacity-50 w-full" value="{{ $tanagyou_detail->minute }}"></td>
                                            <td class="table-checkbox" data-th="初盆">
                                            ...
                                            <td data-th="時間"><input type="text" name="time_{{$i}}" id="time_{{$i}}" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus-ring-opacity-50 w-full" value="{{ $tanagyou_detail->time }}"></td>
                                            <td data-th="担当者">
