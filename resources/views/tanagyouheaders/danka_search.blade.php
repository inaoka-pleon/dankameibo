        ...
        <div class="mb-4 flex flex-col justify-center items-center">
            <div class="flex justify-between bg-white border-l-8 border-b-2 border-slate-500 shadow-sm py-3 sm:py-4 px-4 sm:px-4 rounded-bl w-full max-w-7xl">
                ...
                <div class="inline-flex -mt-1">
                    ...
                    <a href="{{ route('tanagyouheader.edit', $tanagyou_header_id) }}">
        ...
        <div class="flex flex-col justify-center items-center mb-8">
            <div class="mb-4 w-full max-w-7xl">
                ...
                <div id="search_body" class="px-6 sm:px-4 md:px-6 py-4 bg-white shadow-md border border-gray-200 rounded-b-xl" style="display: block;">
                    <form action="{{ route('tanagyouheader.danka_search', $tanagyou_header_id) }}" method="GET">
                        <div class="grid grid-cols-12">
                            ...
                            <div class="col-span-12 sm:col-span-4 py-1 sm:py-2 sm:pl-2">
                                <input type="text" name="cond_tanagyou[namekana]" value="{{ $cond_tanagyou['namekana'] ?? null }}" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus-ring-opacity-50 w-full" id="k_namekana">
                            </div>
                            ...
                            <div class="col-span-12 sm:col-span-4 py-1 sm:py-2 sm:pl-2">
                                <input type="text" name="cond_tanagyou[name]" value="{{ $cond_tanagyou['name'] ?? null }}" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus-ring-opacity-50 w-full" id="k_name">
                            </div>
                            ...
                            <div class="col-span-12 sm:col-span-4 py-1 sm:py-2 sm:pl-2">
                                <select type="text" name="cond_tanagyou[area]" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus-ring-opacity-50 w-full">
                                    <option value=""></option>
                                    @foreach($areas as $area)
                                        <option value="{{ $area->value1 }}" @if(!empty($cond_tanagyou['area']) && $cond_tanagyou['area'] === $area->value1) selected @endif>{{ $area->value1 }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="mt-3 flex items-center sm:justify-end">
                            <button type="submit" class="btn-primary proc-btn text-xs shadow-sm py-3 px-4 mr-3" name="searchType" value="tanagyou_search">
            ...
            <div class="w-full md:mb-4 max-w-7xl text-sm sm:text-base">
                <div class="">
                    <form action="{{ route('tanagyouheader.add_danka_data', $tanagyou_header_id) }}" method="POST">
                        @csrf
                        <div class="mb-4">
