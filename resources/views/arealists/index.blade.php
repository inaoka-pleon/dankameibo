    ...
    <main class="mt-1 py-4 px-2 sm:px-4">
        ...
        <div class="mb-4 flex flex-col justify-center items-center">
            <div class="flex justify-between bg-white border-l-8 border-b-2 border-slate-500 shadow-sm py-3 sm:py-4 px-4 sm:px-4 rounded-bl w-full max-w-7xl">
                <div class="text-gray-800 text-xl font-semibold">地区別名簿一覧表</div>
                        ...
                        <table class="table-danka radius-table shadow">
                            ...
                            <tbody>
                                @foreach ($arealists as $arealist)
                                    <tr>
                                        <td>{{ $arealist->name }}</td>
                                        <td>{{ $arealist->dankadivision }}</td>
                                        <td>{{ $arealist->area }}</td>
                                        <td>{{ $arealist->postcode }}</td>
                                        <td>{{ $arealist->address1 . $arealist->address2 }}</td>
                                        <td>{{ $arealist->tel }}</td>
                                        <td>{{ $arealist->postcard }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
