                            ...
                            <table class="table-jiin">
                                <tr>
                                    ...
                                    <td class="registration-body">
                                        <input type="text" name="accountno1" class="registration-input-middle" placeholder="５文字" value="{{ old('accountno1', $paymentslip->accountno1) }}" /> ー
                                        <input type="text" name="accountno2" class="registration-input-middle" placeholder="１文字" value="{{ old('accountno2', $paymentslip->accountno2) }}" /> ー
                                        <input type="text" name="accountno3" class="registration-input-middle" placeholder="７文字以内" value="{{ old('accountno3', $paymentslip->accountno3) }}" />
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="registration-body">
                                        <input type="text" name="price" class="registration-input-middle" value="{{ old('price', $paymentslip->price) }}" /> 円
                                    </td>
                                </tr>
                                <tr>
