    ...
    <main class="py-2 px-2 sm:px-4">
        ...
        <div class="mb-3 flex flex-col justify-center items-center">
            <div class="header-container">
                <div class="header-title">檀家詳細</div>
                <div class="header-buttons">
                    <a class="header-btn" href="{{ route('danka.index') }}">終了</a>
                </div>
            </div>
        </div>
            ...
            <div class="max-w-7xl mx-auto sm:px-6" >
                <div class="">
                    <div class="">
                        ...
                        <div class="flex flex-col justify-center items-center">
                            <hr class="w-full mb-3 mt-3 max-w-7xl">
                        </div>
                                ...
                                <p class="c-txtsp">
                                    ...
                                    <table class="table_family">
                                        ...
                                        @foreach ($families as $family)
                                            ...
                                            <td data-th="氏名かな">{{$family->namekana}}</td>
                                            <td data-th="続柄">{{$family->relationship}}</td>
                                            <td>
                                    ...
                                    <p class="c-txtsp">
                                        ...
                                        <table class="table_kakocho">
                                            ...
                                            @foreach ($kakochos as $kakocho)
                                                <tr>
                                                    <td data-th="戒名">{{ $kakocho->kaimyou }}</td>
                                                    <td data-th="俗名">
                                                        <a href="{{ route('kakocho.show', $kakocho->id )}}" class="blue_line">{{ $kakocho->zokumyou }}<a>
                                                    </td>
                                                    <td data-th="命日">{{ AD_to_JA_conv_calender($kakocho->deathanniversary) }}</td>
                                                    <td data-th=""> <div class="btn-center">
