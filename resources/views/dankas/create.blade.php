    ...
    <main class="mt-1 py-4 px-2 sm:px-4">
        ...
        <div class="mb-4 flex flex-col justify-center items-center">
            <div class="flex justify-between bg-white border-l-8 border-b-2 border-slate-500 shadow-sm py-3 sm:py-4 px-4 sm:px-4 rounded-bl w-full max-w-7xl">
                <div class="text-gray-800 text-xl font-semibold">檀家 / 新規登録</div>
            </div>
        </div>
                ...
                <table class="registration-table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="registration-body">
                                <input type="text" name="address1" class="registration-input" placeholder="" value="{{ old('address1') }}" />
                            </td>
                        </tr>
                        <tr>
                            <th class="registration-item">住所２</th>
                            <td class="registration-body">
                                <input type="text" name="address2" class="registration-input" placeholder="" value="{{ old('address2') }}" />
                            </td>
                        </tr>
                        <tr>
                            <th class="registration-item">電話番号</th>
                            <td class="registration-body">
                                <input type="text" name="tel" class="registration-input" placeholder="09012345678" value="{{ old('tel') }}" />
                            </td>
                        </tr>
                        <tr>
                            <th class="registration-item">FAX</th>
                            <td class="registration-body">
                                <input type="text" name="fax" class="registration-input" placeholder="09012345678" value="{{ old('fax') }}" />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="registration-body">
                                ...
                                <input type="checkbox" name="report" class="registration-input" value="1" {{ old('report') ? 'checked' : '' }}> 届出
                                <input type="hidden" name="tanagyou" value="0">
                                <input type="checkbox" name="tanagyou" class="registration-input" value="1" {{ old('tanagyou') ? 'checked' : '' }}> 棚経
                                <input type="hidden" name="haruhigan" value="0">
                                <input type="checkbox" name="haruhigan" class="registration-input" value="1" {{ old('haruhigan') ? 'checked' : '' }}> 春彼岸
                                <input type="hidden" name="akihigan" value="0">
                                <input type="checkbox" name="akihigan" class="registration-input" value="1" {{ old('akihigan') ? 'checked' : '' }}> 秋彼岸
                                <input type="hidden" name="hanamatsuri" value="0">
                                <input type="checkbox" name="hanamatsuri" class="registration-input" value="1" {{ old('hanamatsuri') ? 'checked' : '' }}> 花まつり
                            </td>
                        </tr>
                        <tr>
