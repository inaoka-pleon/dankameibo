    ...
    <main class="mt-1 py-4 px-2 sm:px-4">
        ...
        <div class="mb-4 flex flex-col justify-center items-center">
            <div class="flex justify-between bg-white border-l-8 border-b-2 border-slate-500 shadow-sm py-3 sm:py-4 px-4 sm:px-4 rounded-bl w-full max-w-7xl">
                <div class="text-gray-800 text-xl font-semibold">本堂掲示用一覧表</div>
                        ...
                        <table class="table-danka radius-table">
                            ...
                            <tbody>
                                @foreach ($hondoulists as $hondoulist)
                                    <tr>
                                        <td>{{ $hondoulist->death_era_name . $hondoulist->death_year . '年' }}</td>
                                        <td>{{ $hondoulist->kaiki }}</td>
                                        <td>{{ $hondoulist->chief_name }}</td>
                                        <td>{{ $hondoulist->kaimyou }}</td>
                                        <td>{{ $hondoulist->zokumyou }}</td>
                                        <td>{{ $hondoulist->death_era_name . $hondoulist->death_year. '年'. $hondoulist->death_month. '月'. $hondoulist->death_day. '日' }}</td>
                                        <td>{{ $hondoulist->ageatdeath }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
