        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('admin.jiin.index')" :active="request()->routeIs('admin.jiin.index')">
                        寺院
                    </x-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('admin.era.index')" :active="request()->routeIs('admin.era.index')">
                        元号
                    </x-nav-link>
                </div>
